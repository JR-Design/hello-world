...
intro.to(".hide2 span", {y:"0%", duration:1, delay: 0.35, stagger: 0.35 });
...
intro.to("#colorSelector", {scaleY: 1, translateX: 0, duration: 0.5, delay: 0, stagger: 0.25 });
...
/*
const currentLoad = localStorage.getItem("loaded");
...
intro.fromTo("main", { opacity: 1 }, { opacity: 1, duration: 1 }, "-=1");
    ...
    intro.to(".text", { y: "0%", duration: 0.00001, stagger: 0 });
    intro.to(".slider2", { y: "-100%", duration: 0.0001, delay: 0 });
    intro.to(".intro", { y: "-100%", duration: 0.00001 }, "-=1.5");
    intro.fromTo("main", { opacity: 1 }, { opacity: 1, duration: 1 }, "-=1");
  }
}
